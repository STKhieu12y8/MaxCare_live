...
namespace maxcare
{
	...
	public class Comon
	{
        ...
        public static ResponseTrailLicense checkDate(string serial_number)
        {
            RequestHTTP requestHTTP = new RequestHTTP();
            requestHTTP.SetSSL(SecurityProtocolType.Tls12);
            requestHTTP.SetKeepAlive(k: true);
            requestHTTP.SetDefaultHeaders(new string[2] { "content-type: text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8", "user-agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/74.0.3729.131 Safari/537.36" });
            global::License.ResponseTrailLicense responseTrailLicense = new global::License.ResponseTrailLicense();
            ResponseTrailLicense a_responseTrailLicense = responseTrailLicense.checkDate(serial_number);
			return a_responseTrailLicense;
